...
import { SharedDropdown, SharedTextField } from "@/core/components/form-elements/FormElements";
...
const BasicInfo: React.FC = () => {
  return <Box className="create-template-basic-info">
    ...
    <Box className="create-template-basic-info__row">
      <Box className="create-template-basic-info__row-item create-template-basic-info__dropdown-container">
        {/* TODO: SharedDropdown component from FormElement will replaced when shared Select file added */}
        <Box className={clsx({"create-template-basic-info__label": true, "required-icon": true})}>{BASIC_INFO.directory}</Box>
        <Box className="create-template-basic-info__dropdown-row">
          <SharedDropdown 
            ...
            menuClassName="create-template-basic-info__dropdown-menu" 
          />
          <SvgIcon component={ChevronRight} color="secondary" size={24} />
          <SharedDropdown 
            options={directoryDropdownOptions} 
