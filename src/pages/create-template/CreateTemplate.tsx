...
import { CREATE_TEMPLATE_HEADING, CREATE_TEMPLATE_STEPS } from "./constants/constant";
import "./CreateTemplate.scss";

const CreateTemplate: React.FC = () => {
    const navigate = useNavigate();
    const { basicInfo, questions, advancedOption, notification, followUp} = CREATE_TEMPLATE_STEPS;
    ...
    { label: basicInfo.label, value: basicInfo.value, component: <BasicInfo/>, checkValidity: useCallback(() => true, [])},
    { label: questions.label, value: questions.value, component: <Questions/>, checkValidity: useCallback(() => true, [])},
    { label: advancedOption.label, value: advancedOption.value, component: <AdvancedOptions/> },
    { label: notification.label, value: notification.value, component: <Notifications/> },
   ...
   * @returns {void}
   */
  const handleStepChange = useCallback((event: { activeStep: number; data: StepOption }) => {
