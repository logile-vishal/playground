...
export const getTaskTypes: () => Promise<
  PaginatedResponse<TaskTypeOptions>
> = () => {
 ...
 */
export const getTaskTags: () => Promise<
  PaginatedResponse<TagOptionsType>
> = () => {
 ...
 */
export const getQuestionTags: () => Promise<
  PaginatedResponse<TagOptionsType>
> = () => {
